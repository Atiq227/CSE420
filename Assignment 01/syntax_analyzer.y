...
%token IF ELSE WHILE ADDOP COMMA FOR DO INT FLOAT VOID SWITCH DEFAULT GOTO BREAK CHAR DOUBLE RETURN CASE CONTINUE PRINTLN MULOP INCOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COLON SEMICOLON ID CONST_INT CONST_FLOAT DECOP
